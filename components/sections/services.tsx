      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid gap-5 lg:grid-cols-[.9fr_1.1fr] lg:items-end">
          <div>
            ...
            <h2 className="mt-3 max-w-xl text-3xl font-extrabold tracking-tight text-[#17204f] sm:text-4xl">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {services.map(({ icon: Icon, ...service }) => (
            <article
              key={service.title}
              className="group flex min-h-80 flex-col rounded-2xl border border-stone-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-rose-200 hover:shadow-[0_20px_50px_rgba(23,32,79,.10)]"
            >
              <div className="flex items-center justify-between">
                <span className="grid size-12 place-items-center rounded-xl bg-indigo-50 text-[#273b82] transition group-hover:bg-rose-500 group-hover:text-[#17204f]">
                  <Icon size={22} />
                </span>
              ...
              <h3 className="mt-7 text-xl font-extrabold text-[#17204f]">
                {service.title}
              </h3>
              ...
              <Link
                href={service.href}
                className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-[#273b82]"
              >
