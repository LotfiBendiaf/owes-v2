...
export default function CallToAction() {
  return (
    <section className="px-6 pb-20">
      <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-7 rounded-4xl bg-slate-100 p-8 text-brand-950 sm:p-10 lg:flex-row lg:items-center">
        <div>
