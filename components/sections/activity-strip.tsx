...
export default function ActivityStrip() {
  return (
    <section className="overflow-hidden bg-white py-10">
      ...
      <div className="mx-auto mt-7 flex max-w-5xl flex-wrap items-center justify-center gap-x-12 gap-y-5 px-6 text-sm font-extrabold uppercase tracking-wider text-slate-600">
