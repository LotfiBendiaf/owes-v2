...
describe("service request pricing", () => {
  it("quotes every active offer from server-owned rules", () => {
    ...
    expect(quoteServiceRequest({ ...common, kind: "ENTERPRISE_PACK", option: "pack", people: 5 })).toBe(50_000);
    ...
    expect(quoteServiceRequest({ ...common, kind: "WEBSITE_BUILDING", option: "starter" })).toBe(120_000);
