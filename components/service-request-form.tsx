...
type Kind = "MEETING" | "COWORKING" | "TRAINING" | "DOMICILIATION" | "WEBSITE_BUILDING" | "ENTERPRISE_PACK";

const optionsByKind: Record<Kind, readonly [string, string][]> = {
  ENTERPRISE_PACK: [["pack", "Pack entreprise"]],
