  ...
  return (
    <section className="px-4 pb-10 pt-28 sm:px-6 lg:px-8">
      <div className="relative mx-auto min-h-[76vh] max-w-7xl overflow-hidden rounded-4xl bg-[#101735] shadow-[0_30px_90px_rgba(23,32,79,.22)]">
        <HeroCarousel />
        <div className="relative flex min-h-[76vh] items-center px-7 pb-24 pt-16 sm:px-12 lg:px-16">
          <div className="relative z-10 max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link href="/services" className="inline-flex h-12 items-center gap-2 rounded-full bg-white px-6 text-sm font-bold uppercase text-[#273b82] transition hover:bg-slate-100">
            ...
            <div className="mt-7 inline-flex items-center gap-3 rounded-2xl border border-white/15 bg-[#101735]/40 px-4 py-3 text-white backdrop-blur-md">
